        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                { href: "https://wa.me/918605887561", label: "WhatsApp", icon: (
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-crimson-300">
              ...
              <p>
                <a href="mailto:swapnilg836@gmail.com" className="hover:text-gold-400 transition-colors">
                  ✉ swapnilg836@gmail.com
                </a>
              </p>
            </div>
          </div>
